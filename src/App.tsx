    ...
    <div className="min-h-screen bg-[#1a1a1a] text-white overflow-x-hidden">
      ...
      <section id="home" className="h-screen relative flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl">
          ...
          >
            <motion.h1
              className="text-7xl mb-6 text-[#b8860b]"
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8, delay: 0.5 }}
              style={{
                textShadow: '0 0 30px rgba(184, 134, 11, 0.6), 0 0 60px rgba(184, 134, 11, 0.3)',
              }}
            >
              孫悟空形象的起源|演變|傳播
            </motion.h1>
        ...
        >
          <div className="flex flex-col items-center gap-2">
            ...
            <span className="text-xs text-[#8b7355]">Scroll Down</span>
          </div>
        </motion.div>
      </section>
